...
export var wallSound = new soundFile("wind01.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("bounce.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("wavebig.mp3");
